      ...
      <div className='row' style={{ flex: "1 0 0" }}>
        ...
        <div className="column">
          ...
          <div className="fact-card">
            <h1>Did you know</h1>
            <p>The total amount of energy (to date) generated by Diamond's solar panels is enough to operate the facility for { }
              <b>{Math.floor((pvMap.get("SV-BM-UPS-01:PVS:TOTALPV:DLSPVMWH") ?? 0) / 153)} days</b>, with no other power sources</p>
          </div>
        </div>
      </div>
    </div>
